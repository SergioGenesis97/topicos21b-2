...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/usuarios_create" class="nav-link bg-dark">
                                        <i class="material-icons nav-icon">person_add</i>
                                        <p>Agregar Usuarios</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/usuarios_show" class="nav-link bg-dark">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2021-2032 <a href="#">SR</a>.</strong> Todos los derechos reservados.
        </footer>
    </div>
    <!-- ./wrapper -->

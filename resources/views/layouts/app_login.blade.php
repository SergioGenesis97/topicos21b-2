...
<head>
    ...
    <title>{{ __('Topicos Selectos II') }}</title>
    ...
    <!-- CSS Files -->
    <link href="{{ asset('dist') }}/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
</head>
...
<body class="{{ $class ?? '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="active">
                    <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{ asset('dist') }}/img/sidebar-1.jpg" alt="">
                    </a>
                </li>
                <li>
                    <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{ asset('dist') }}/img/sidebar-2.jpg" alt="">
                    </a>
                </li>
                <li>
                    <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{ asset('dist') }}/img/sidebar-3.jpg" alt="">
                    </a>
                </li>
                <li>
                    <a class="img-holder switch-trigger" href="javascript:void(0)">
                        <img src="{{ asset('dist') }}/img/sidebar-4.jpg" alt="">
                    </a>
                </li>
    ...
    <script src="{{ asset('dist') }}/js/material-dashboard.js?v=2.1.1" type="text/javascript"></script>
    @stack('js')
</body>
